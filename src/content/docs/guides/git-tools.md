...
Every worktree's right-click menu offers **"Open lazygit here"** — it spawns vanilla
[lazygit](https://github.com/jesseduffield/lazygit) in a new pane scoped to that worktree's directory.
If lazygit isn't installed you get a calm notice, not an error dialog. This is deliberate
...
state and drift in the [worktrees sidebar](/guides/worktrees/), and dirty-git
